    ...
    <div className="min-h-screen flex flex-col items-center justify-center px-6 bg-[#5A86CB] relative overflow-hidden">
      ...
      <div className="relative w-full max-w-sm">
        <div className="text-center mb-10">
          <p className="font-[family-name:var(--font-cormorant)] text-5xl font-light italic text-[#F2AEBC] mb-3">
            Jim &amp; Maria
          </p>
          <div className="w-10 h-px bg-[#F2AEBC] mx-auto mb-4" />
          <p className="text-xs tracking-[0.25em] uppercase text-[#F2DCDB] font-light">
            Private — guests only
          </p>
        </div>
        ...
        <p className="mt-8 text-center text-xs text-[#F2DCDB] font-light">
