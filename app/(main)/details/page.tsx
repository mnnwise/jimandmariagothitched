    ...
    <div className="max-w-2xl mx-auto px-4 sm:px-6 py-10 md:py-16">
      ...
      <div className="space-y-12">
        ...
        <section>
          ...
          <p className="text-base text-[#F2DCDB] font-light leading-relaxed mb-6">
          ...
          <div className="space-y-5">
            <div>
              <p className="font-[family-name:var(--font-cormorant)] text-lg font-light text-[#F2DCDB]">Anna &amp; Bel</p>
              <p className="text-xs text-[#F2DCDB] font-light mb-1">5 minute drive to Middle Child</p>
            ...
            <div>
              <p className="font-[family-name:var(--font-cormorant)] text-lg font-light text-[#F2DCDB]">The Gas Lamp Hotel</p>
              <p className="text-xs text-[#F2DCDB] font-light mb-1">10 minute drive to Middle Child</p>
        ...
        <section>
          ...
          <p className="text-base text-[#F2DCDB] font-light leading-relaxed mb-4">
