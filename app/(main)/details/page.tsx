    ...
    <div className="max-w-2xl mx-auto px-4 sm:px-6 py-10 md:py-16">
      ...
      <div className="space-y-12">
        ...
        <section>
          ...
          <p className="text-base text-[#4d6b7e] font-light leading-relaxed mb-6">
          ...
          <div className="space-y-5">
            <div>
              ...
              <a href="https://annaandbel.com/reservations" target="_blank" rel="noopener noreferrer" className="text-xs tracking-[0.15em] uppercase font-light text-[#b06070] hover:text-[#1e3348] transition-colors border-b border-[#e8c5c5] pb-0.5">
                Reservations
              </a>
            </div>
            <div>
              ...
              <a href="https://thegaslamphotel.com/book" target="_blank" rel="noopener noreferrer" className="text-xs tracking-[0.15em] uppercase font-light text-[#b06070] hover:text-[#1e3348] transition-colors border-b border-[#e8c5c5] pb-0.5">
                Reservations
              </a>
            </div>
          </div>
        ...
        <section>
          ...
          <p className="text-base text-[#4d6b7e] font-light leading-relaxed mb-4">
